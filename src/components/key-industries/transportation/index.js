    ...
    return (
      <div className='JSX-WRAP'>
        ...
        <div className={'card card-content' + toggleClass}>
          ...
          <ul>
            <li>
              <span>GPS 3 Axis Location Assignment</span>
            ...
            <li>
              <span>Mile Post + Highway Location</span>
            ...
            <li>
              <span>Work Operation Codes</span>
